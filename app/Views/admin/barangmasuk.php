            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?= base_url('/admin/tambahDataBarangMasuk'); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" aria-label="Default select example" name="produk_id">
                ...
                <?php foreach ($BarangMasuks as $key => $BarangMasuk) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="modal fade" id="infoData<?= $BarangMasuk['id_barang_masuk'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label for="" class="form-label">Tanggal: <?= date('d F Y', strtotime($BarangMasuk['created_at'])) ?></label>
                                            </div>
                                            <div class="form-group">
                                                <label for="" class="form-label">Supplier: <?= $BarangMasuk['nama_supplier'] ?></label>
                                            </div>
                                            <div class="form-group">
                                                <label for="" class="form-label">Produk: <?= $BarangMasuk['nama_produk'] ?></label>
                                            </div>
                                            <div class="form-group">
                            ...
                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#editData<?= $BarangMasuk['id_barang_masuk'] ?>">
                                <i class="fa fa-pencil"></i>
                            </button>
                            <!-- Modal Edit -->
                            <div class="modal fade" id="editData<?= $BarangMasuk['id_barang_masuk'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?= base_url('/admin/editDataBarangMasuk'); ?>" method="post" enctype="multipart/form-data">
                                                <input type="hidden" name="id_barang_masuk" value="<?= $BarangMasuk['id_barang_masuk'] ?>">
                                                <div class="form-group">
                                                    <label for="inputSupplier" class="form-label">Nama Supplier : </label>
                                                    <select class="form-control" aria-label="Default select example" name="id_supplier">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" aria-label="Default select example" name="produk_id">
                                                        <option selected disabled>Pilih Produk</option>
                                                        <?php foreach ($produks as $produk) : ?>
                                                            <option value="<?= $produk['id_produk']; ?>" <?= ($BarangMasuk['id_produk'] == $produk['id_produk']) ? 'selected' : ''; ?>>
                                                                <?= $produk['nama_produk'] ?>
                                                            </option>
                                                        <?php endforeach; ?>
                                                    </select>
                            ...
                            <!-- End Modal Edit -->
                            <!-- Modal Hapus -->
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#hapusData<?= $BarangMasuk['id_barang_masuk'] ?>">
                                <i class="fa fa-trash"></i>
                            </button>
                            <div class="modal fade" id="hapusData<?= $BarangMasuk['id_barang_masuk'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                            <form action="<?= base_url('/admin/hapusDataBarangMasuk/' . $BarangMasuk['id_barang_masuk']); ?>" method="post">
