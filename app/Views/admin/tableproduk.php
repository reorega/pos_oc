        ...
        <tr>
            ...
            <td>
                <button type="button" class="btn btn-success"
                    onclick="window.open('<?= base_url('/admin/barcode/' . $pdk['id_produk'])?>','blank')">
                            ...
                            <div class="modal-body">
                                <form action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="editStok<?= $pdk['id_produk']?>"
                                            name="stok" value="<?= $pdk['stok'] ?>">
                                    </div>
