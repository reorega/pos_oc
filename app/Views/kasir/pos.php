                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-lg" name="totalbayar" id="totalbayar"
                                style="text-align: right; color:blue; font-weight : bold; font-size:30pt;" value="0"
                                readonly>
                        </div>
                        <div class="form-group">
                            <label for="jumlahpembayaran">Pembayaran</label>
                            <input type="number" class="form-control form-control-lg" name="jumlahpembayaran"
                                id="jumlahpembayaran">
                        </div>
                        <div class="form-group">
                            <label for="kembalian">Total Kembalian</label>
                            <input type="number" class="form-control form-control-lg" name="kembalian" id="kembalian"
                                value="0" readonly>
                        </div>
                        <div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status == 'error') {
                        Swal.fire({
                            title: "Error!",
                            text: "Stok Produk tersebut kosong!",
                            icon: "info"
                        });
                    }
